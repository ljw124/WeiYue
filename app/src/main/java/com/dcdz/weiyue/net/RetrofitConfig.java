...
import com.dcdz.weiyue.been.Constants;
...
public class RetrofitConfig {
    ...
    //max-stale指示客户机可以接收超出超时期间的响应消息，max-stale可以配合设置缓存失效时间
     ...
     * Cache-control是由服务器返回的Response中添加的头信息，它的目的是告诉客户端是要从本地读取缓存还是直接从服务器摘取消息
     */
